    ...
    <div class="jumbotron">
        ...
        <form class="form-horizontal" action="/" method="post">
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input class="form-control" id="email" placeholder="Enter email" name="userNameCampus"></input>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <label class="control-label col-sm-2" for="email">Username:</label>
                <div class="col-sm-10">
                    <input type="email" class="form-control" id="email2" placeholder="Enter email" name="userNameGoogle"></input>
                </div>
            </div>
            <div class="form-group">
